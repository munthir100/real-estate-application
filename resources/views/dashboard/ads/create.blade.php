            ...
            <div class="col-lg-9 col-md-12">
                <div id="app">
                    <div class="dashboard-wraper1">
                        <form method="POST" action="{{route('dashboard.ads.store')}}" accept-charset="UTF-8" id="botble-real-estate-forms-account-property-form" class="js-base-form dirty-check" enctype="multipart/form-data">
                            @csrf
                            @if($errors->any())
                                        ...
                                        <div class="main-form">
                                            <div class="form-body">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input required class="form-control" placeholder="Title" data-counter="120" v-pre name="title" type="text" id="title">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input required class="form-control" placeholder="Property location" data-counter="300" v-pre name="location" type="text" id="location">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group mb-3 col-md-3">
                                                        ...
                                                        <input class="form-control" placeholder="Number bedrooms" v-pre name="number_of_bedrooms" type="number" id="number_of_bedrooms">
                                                    ...
                                                    <div class="form-group mb-3 col-md-3">
                                                        ...
                                                        <input class="form-control" placeholder="Number bathrooms" v-pre name="number_of_bathrooms" type="number" id="number_of_bathrooms">
                                                    ...
                                                    <div class="form-group mb-3 col-md-3">
                                                        ...
                                                        <label for="number_of_floor" class="control-label">Number floors</label>
                                                        <input class="form-control" placeholder="Number floors" v-pre name="number_of_floor" type="number" id="number_of_floor">
                                                    ...
                                                    <div class="form-group mb-3 col-md-3">
                                                        ...
                                                        <input class="form-control" placeholder="Square :unit" v-pre name="square" type="number" id="square">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group mb-3 col-md-4">
                                                        ...
                                                        <input class="form-control input-mask-number" id="price-number" placeholder="Price" v-pre name="price" type="text">
                                        ...
                                        <div class="widget meta-boxes">
                                            ...
                                            <div class="widget-body">
                                                ...
                                                <label class="checkbox-inline">
                                                    <input name="features[]" type="checkbox" value="{{$feature->id}}">{{$feature->name}}
                                                </label>&nbsp;
                                                @endforeach
                                            </div>
                                        </div>
                                                ...
                                                <div class="widget-body">
                                                    ...
                                                    <div class="seo-edit-section hidden" v-pre>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <textarea class="form-control" rows="3" id="seo_description" placeholder="SEO description" data-counter="160" name="seo_meta[seo_description]" cols="50"></textarea>
                                                        </div>
                                                    </div>
