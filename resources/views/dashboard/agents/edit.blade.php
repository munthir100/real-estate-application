...
@section('title', $agent->user->first_name . ' ' . $agent->user->last_name)
                        ...
                        <div class="form-submit">
                            ...
                            <div class="row">
                                <div class="col-lg-8 order-lg-0">
                                    <form action="{{route('agents.update',$agent->id)}}" id="setting-form" method="POST">
                                        @method('put')
                                        @csrf
                                        <div class="form-group">
                                            <label for="first_name">First name</label>
                                            <input type="text" class="form-control" name="first_name" id="first_name" required value="{{$agent->user->first_name}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="username" id="username" required value="{{$agent->user->username}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="phone" id="phone" required value="{{$agent->user->phone}}">

                                        </div>
                                        <!--Short description-->
                                        <div class="form-group">
                                            <label for="description">Short description</label>
                                            <textarea class="form-control" name="description" id="description" rows="3" maxlength="300" placeholder="Tell something about yourself...">{{$agent->user->description}}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="email" id="email"  placeholder="{{$agent->user->email}}" required value="{{$agent->user->email}}">
                                            @if($errors->has('email'))
                                            <span class="invalid-feedback d-block">
                                                <strong>
                                                    {{ $errors->first('email') }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="birth_date" id="birth_date" placeholder="{{$agent->user->birth_date}}" required value="{{$agent->user->birth_date}}">
