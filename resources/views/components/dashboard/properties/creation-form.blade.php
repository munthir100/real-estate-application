            ...
            <div class="main-form">
                <div class="form-body">
                    <div class="form-group mb-3">
                        ...
                        <input required class="form-control" placeholder="{{__('Title')}}" data-counter="120" v-pre name="title" type="text" id="title">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input required class="form-control" placeholder="{{__('Property location')}}" data-counter="300" v-pre name="location" type="text" id="location">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <input class="form-control" placeholder="Ex: 1.462260" data-counter="25" v-pre name="latitude" type="text" id="latitude">
                        ...
                        <div class="form-group mb-3 col-md-6">
                            ...
                            <input class="form-control" placeholder="Ex: 103.812530" data-counter="25" v-pre name="longitude" type="text" id="longitude">
                            <a class="help-block" href="https://www.latlong.net/convert-address-to-lat-long.html" target="_blank" rel="nofollow">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group mb-3 col-md-3">
                            ...
                            <input class="form-control" placeholder="{{__('Number bedrooms')}}" v-pre name="number_of_bedrooms" type="number" id="number_of_bedrooms">
                        ...
                        <div class="form-group mb-3 col-md-3">
                            ...
                            <input class="form-control" placeholder="{{__('Number bathrooms')}}" v-pre name="number_of_bathrooms" type="number" id="number_of_bathrooms">
                        ...
                        <div class="form-group mb-3 col-md-3">
                            ...
                            <label for="number_of_floor" class="control-label">{{__('Number floors')}}</label>
                            <input class="form-control" placeholder="{{__('Number floors')}}" v-pre name="number_of_floor" type="number" id="number_of_floor">
                        ...
                        <div class="form-group mb-3 col-md-3">
                            ...
                            <label for="square" class="control-label">{{__('Square')}} (m&sup2;)</label>
                            <input class="form-control" placeholder="{{__('Square')}} :unit" v-pre name="square" type="number" id="square">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group mb-3 col-md-4">
                            ...
                            <input class="form-control input-mask-number" id="price-number" placeholder="{{__('Price')}}" v-pre name="price" type="text">
                        ...
                        <div class="form-group mb-3 col-md-4">
                            ...
                            <div class="ui-select-wrapper form-group ">
                                <select class="form-control select-full ui-select" v-pre id="currency_id" name="currency_id">
                                    <option value="{{App\Models\Currency::USD}}">{{__('USD')}}</option>
                                    <option value="{{App\Models\Currency::SAR}}">{{__('SAR')}}</option>
                                </select>
                                <svg class="svg-next-icon svg-next-icon-size-16">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                        <path d="M10 16l-4-4h8l-4 4zm0-12L6 8h8l-4-4z"></path>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input class="form-control" v-pre name="{{__('label')}}" type="text" id="label">
                    </div>
            ...
            <div class="widget meta-boxes">
                ...
                <div class="widget-body">
                    ...
                    <label class="checkbox-inline">
                        <input name="features[]" type="checkbox" value="{{$feature->id}}">{{__($feature->name)}}
                    </label>&nbsp;
                    @endforeach
                </div>
            </div>
                ...
                <div class="widget meta-boxes" id="youtube">
                    ...
                    <div class="widget-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input id="video_url" class="form-control" placeholder="https://www.youtube.com/watch?v=FN7ALfpGxiI" data-counter="255" name="video[url]" type="text" value="">
                        </div>
                    ...
                    <div class="widget-body">
                        ...
                        <div class="seo-edit-section hidden" v-pre>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" id="seo_title" placeholder="{{__('SEO Title')}}" data-counter="120" name="seo_meta[seo_title]" type="text">
                            </div>
                            <div class="form-group mb-3">
                                <label class="control-label" for="seo_description">{{__('SEO description')}}</label>
                                <textarea class="form-control" rows="3" id="seo_description" placeholder="{{__('SEO description')}}" data-counter="160" name="seo_meta[seo_description]" cols="50"></textarea>
                            </div>
                        </div>
